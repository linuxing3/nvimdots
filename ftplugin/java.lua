  ...
  local jar_patterns = {
    vim.fn.glob(
      env.HOME -- ~/.vscode/extensions/vscjava.vscode-java-debug-0.52.0/
        .. "/.vscode-insiders/extensions/vscjava.vscode-java-debug-0.52.0/com.microsoft.java.debug.plugin-*.jar"
    ),
  }
  vim.list_extend(
    jar_patterns,
    vim.split(
      ...
      vim.fn.glob(env.HOME .. "/.vscode-insiders/extensions/vscjava.vscode-java-test-0.39/server/*.jar"),
      "\n"
    )
  )
  return jar_patterns
...
local function get_jar_patterns()
  local jar_patterns = {}
  local plugin_path = path.join(env.HOME, "/.vscode-insiders/extensions/vscjava.vscode-java-test-0.39/server")
