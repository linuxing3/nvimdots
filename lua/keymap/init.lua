...
local plug_map = {
	["n|Q"] = map_cmd(":qa!<CR>"),
	["n|<leader>qq"] = map_cmd(":qa!<CR>"),
	["n|<leader>ss"] = map_cmd(":sa!<CR>"),
	-- bufdelete.nvim
	["n|<A-q>"] = map_cmd(":Bwipeout<CR>"),
	-- Window navigation
	["n|]w"] = map_cmd(":wincmd l<CR>"),
	["n|[w"] = map_cmd(":wincmd h<CR>"),
	["n|<C-l>"] = map_cmd(":wincmd l<CR>"),
	["n|<C-h>"] = map_cmd(":wincmd h<CR>"),
	["n|<C-j>"] = map_cmd(":wincmd j<CR>"),
	["n|<C-k>"] = map_cmd(":wincmd k<CR>"),
	["i|<C-l>"] = map_cmd(":wincmd l<CR>"),
	["i|<C-h>"] = map_cmd(":wincmd h<CR>"),
	["i|<C-j>"] = map_cmd(":wincmd j<CR>"),
	["i|<C-k>"] = map_cmd(":wincmd k<CR>"),
	-- Buffer navigation
	["n|]b"] = map_cmd(":bn<CR>"),
	["n|[b"] = map_cmd(":bp<CR>"),
	["n|<Tab>"] = map_cmd(":bn<CR>"),
	["n|<S-Tab>"] = map_cmd(":bp<CR>"),
	-- Bufferline
	...
	["v|ca"] = map_cu("Lspsaga code_action"):with_noremap():with_silent(),
	...
	["n|<A-h>"] = map_cr([[execute v:count . "ToggleTerm direction=horizontal"]]):with_noremap():with_silent(),
	["i|<A-h>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=horizontal<CR>"):with_noremap():with_silent(),
	["t|<A-h>"] = map_cmd("<Esc><Cmd>ToggleTerm<CR>"):with_noremap():with_silent(),
	["n|<A-v>"] = map_cr([[execute v:count . "ToggleTerm direction=vertical"]]):with_noremap():with_silent(),
	["i|<A-v>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=vertical<CR>"):with_noremap():with_silent(),
	["t|<A-v>"] = map_cmd("<Esc><Cmd>ToggleTerm<CR>"):with_noremap():with_silent(),
	...
	["n|<A-i>"] = map_cr([[execute v:count . "ToggleTerm direction=float"]]):with_noremap():with_silent(),
	["i|<A-i>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=float<CR>"):with_noremap():with_silent(),
	["t|<A-i>"] = map_cmd("<Esc><Cmd>ToggleTerm<CR>"):with_noremap():with_silent(),
	...
	["n|<f3>"] = map_cr("NvimTreeToggle"):with_noremap():with_silent(),
	["n|<Leader>nf"] = map_cr("NvimTreeFindFile"):with_noremap():with_silent(),
	["n|<Leader>ne"] = map_cr("NvimTreeFindFile"):with_noremap():with_silent(),
	["n|<Leader>nr"] = map_cr("NvimTreeRefresh"):with_noremap():with_silent(),
	-- Plugin Undotree
	["n|<Leader>u"] = map_cr("UndotreeToggle"):with_noremap():with_silent(),
	-- Plugin Telescope
	["n|<C-S-p>"] = map_cu("lua require('telescope').extensions.project.project{}"):with_noremap():with_silent(),
	...
	["n|\\\\"] = map_cu("Telescope find_files"):with_noremap():with_silent(),
	...
	["n|<Leader>fs"] = map_cu("Telescope colorscheme"):with_noremap():with_silent(),
	...
	["n|<Leader><leader>"] = map_cu("Telescope commands"):with_noremap():with_silent(),
	...
	["n|<leader>mv"] = map_cr("MarkdownPreviewToggle"):with_noremap():with_silent(),
	-- Plugin auto_session
	...
	-- Plugin Diffview
	["n|<leader>Do"] = map_cr("DiffviewOpen"):with_silent():with_noremap(),
